...
public class MainGUI extends JFrame {
	...
	public static void main(String[] args) {
		...
		JTextField getCustomerRecordField = new JTextField("Enter last name");
		JTextField deleteCustomerRecordField = new JTextField();
		...
		JLabel statusUpdate2 = new JLabel("Awaiting Selection");

		row15.add(statusUpdate);
		row15.add(statusUpdate2);
		row15.setVisible(true);

		JLabel recordsPrinted = new JLabel();
		...
		JScrollPane scrPane = new JScrollPane(row16);
		scroll.add(scrPane);
		...
		JButton close = new JButton("Close Records Window");
